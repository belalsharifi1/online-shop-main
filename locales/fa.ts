const fa: { [key: string]: string } = {
  ...
  aboutLongText:
    "قالب فروشگاه ZShop جهت تثبیت دانش front-end بنده، با استفاده از تکنولوژی‌هایی نظیر Nextjs, TypeScript, Reactjs, TailwindCSS و ... به عنوان نمونه کار ، نوشته شده. از CafeDX رم.",
